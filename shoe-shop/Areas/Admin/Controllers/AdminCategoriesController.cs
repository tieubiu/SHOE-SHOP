...
namespace OnlineMarket.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriesController : Controller
    {
        ...
        public AdminCategoriesController(OnlineShopContext context, INotyfService notifyfService)
        {
            _context = context;
        ...
        public IActionResult Index(int? page)
        {
            ...
            var pageSize = 20;
            var lsCategorys = _context.Categories.AsNoTracking().OrderByDescending(x => x.CatId);
        ...
        public async Task<IActionResult> Create([Bind("CatId,CatName,Description,ParentId,Levels,Ordering,Published,Thumb,Title,Alias,MetaDesc,MetaKey,Cover,SchemaMarkup")] Category category, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
            if (ModelState.IsValid)
            {
                ...
                _notyfService.Success("Tạo danh mục thành công");
